-- Co-Code Admin Server Database Schema
-- PostgreSQL
...
CREATE TABLE agents (
    ...
    avatar_url VARCHAR(500),
    status VARCHAR(50) DEFAULT 'offline',  -- online, offline, sleeping
...
CREATE TABLE agent_configs (
    ...
    style_favorite_emoji TEXT[] DEFAULT ARRAY['✨', '🎯', '💡'],
...
-- ============================================
-- DESTINATION CONFIGS
-- (Platforms the agent connects to)
-- ============================================
CREATE TABLE destination_configs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    agent_id UUID NOT NULL REFERENCES agents(id) ON DELETE CASCADE,
    destination VARCHAR(50) NOT NULL, -- slack | telegram | x | email | etc
